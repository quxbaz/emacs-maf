...
(maf-defcmds
  ...
  ;; v u) takes what point names apart into its parts, peeling the
  ;; innermost wrapper around point inside a formula, and mafcmd-unwrap
  ;; (j U) is the same reading kept apart on calc's selection prefix.
