...
(maf-defcmds
  ...
  (match binary calcFunc-match "a m" :inv matchnot)
  ...
  (mapeq binary calcFunc-mapeq "a M" :inv mapeqr :hyp mapeqp)
  (roots binary calcFunc-roots "a P")
  (solve binary calcFunc-solve "a S" :inv finv :hyp fsolve :invhyp ffinv)
