...
`maf-history--classify'); and COMMAND the `this-command' the change
landed under, the precise name behind a label that names an operation
              ...
              (let* ((old maf-history--last-raw)
                     ...
                     (label
                      (cond
                       ...
                       ((memq this-command '(maf-reset calc-reset)) "reset")
