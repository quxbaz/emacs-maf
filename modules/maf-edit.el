...
pre-edit point instead of the in-edit one; a home-landing one
\(`maf-edit--return-home') parks it on the dot and marks where it left."
...
group."
  ...
  (let (vals sels errors)
    ...
    (if errors
      ...
      ;; before the mode exit consumes it. A home-landing one is taken
