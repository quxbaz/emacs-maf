...
(maf-step
  ...
  ;; and the fraction-division key for the square.
  (cl-assert (eq (key-binding "=") 'mafcmd-equal-to))
  (cl-assert (eq (key-binding ":") 'mafcmd-sqr))
