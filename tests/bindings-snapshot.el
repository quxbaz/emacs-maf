...
;; refactor must keep every answer identical. Eleven answers have moved
;; since deliberately: C-M-k runs maf-erase, the stack-only successor
;; of maf-reset, which used to wipe the whole session; j U and j M-U
;; took mafcmd-unwrap, the narrowing sibling of mafcmd-unpack, when
;; the contextual unwrap landed; the
...
;; fall-throughs for mafcmd-pow, a second key beside ^ as an edit
;; session already has it, calc's fdiv keeping the key in the calc
;; profile; and & and G left the two
